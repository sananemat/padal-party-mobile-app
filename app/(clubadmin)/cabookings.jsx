...
const SAMPLE_MATCHES = [
  ...
  },
  {
    ...
    courtId: "1",
    name: "Evening Match",
    startDateTime: createDate("2025-10-02", "6:00 PM"),
    endDateTime: createDate("2025-10-02", "7:00 PM"),
  },
  {
    id: "4",
    courtId: "1",
...
export default function CABookings() {
  ...
  const now = new Date();
  const nowdiff = new Date().toLocaleString()
  const today = new Date(Date.UTC(now.getUTCFullYear(), now.getUTCMonth(), now.getUTCDate()));

  // 🔹 Categorize matches
  const categorizedMatches = SAMPLE_MATCHES.reduce((acc, match) => {
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
          ...
          filteredMatches.map((match) => {
            ...
            return (
              <CAProfileCard key={match.id} style={styles.matchCard}>
                <Image
                  source={{ uri: court?.image || SAMPLE_COURTS[0].image }}
        ...
        <>
            ...
            <CAProfileCard style={styles.actionCard}>
                <TouchableOpacity style={styles.actionCardContent} onPress={() => {}}>
