// app/components/AddCourtModal.jsx
...
export default function AddCourtModal({
  ...
  const [color, setColor] = useState("#0e4fe5ff");
  ...
  const handleAdd = () => {
    ...
    const newCourt = {
      ...
      rating: 5,
      court_type: "indoor",
      floor_type: "Synthetic Turf",
      description: "Description Text",
      status: "Active",
      picture: imageUri || SAMPLE_COURT_IMAGE, // Use your default image
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
              <View style={styles.content}>
                ...
                <View style={styles.actions}>
                  ...
                  <TouchableOpacity style={styles.updateButton} onPress={handleAdd}>
